...
import { Optimization } from "@/components/sections/Optimization";
import { CTRScore } from "@/components/sections/CTRScore";
import { EthicalGuardrail } from "@/components/sections/EthicalGuardrail";
import { ShieldCheck, Sparkles, Zap, BarChart3, ArrowLeft } from "lucide-react";

const AppPage = () => {
  const [activeTab, setActiveTab] = useState("Ad Generation");
  ...
  return (
    <div className="h-screen bg-background text-foreground flex">
      <Sidebar
        tabs={[
          { name: "Ad Generation", icon: Sparkles },
          { name: "Optimization", icon: Zap },
          { name: "CTR Score", icon: BarChart3 },
          { name: "Ethical Guardrail", icon: ShieldCheck },
        ]}
        activeTab={activeTab}
